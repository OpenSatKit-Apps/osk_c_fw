      ...
      switch (ValueType) {
         ...
         case JSONString:
            ...
            if (ValueLen <= Obj->TblDataLen) {
               ...
               CFE_EVS_SendEvent(CJSON_LOAD_OBJ_EID, CFE_EVS_DEBUG, "JSON string %s, len = %ld", Value, ValueLen);
         ...
         case JSONNumber:
            ...
            CFE_EVS_SendEvent(CJSON_LOAD_OBJ_EID, CFE_EVS_DEBUG, "JSON number %s, len = %ld", Value, ValueLen);
