...
static const char* JsonFileStatusStr[] = {
...
**
*/
const char* JSON_GetFileStatusStr(int Enum) {
...
**
*/
const char* JSON_GetJsmnErrStr(int Enum) {
...
**
*/
const char* JSON_GetJsmnTypeStr(int Enum) {
...
*/
const char* JSON_GetBoolStr (uint16 State) {

   static const char* BoolStr[] = {"true", "false", JSON_UNDEF_VAL_STR};
